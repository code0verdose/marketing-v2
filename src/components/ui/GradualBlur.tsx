...
// Adapted: replaced mathjs with native Math to avoid extra dependency.
...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const deb = debounce(calc as (...a: unknown[]) => void, 100);
    calc();
  ...
  return responsive
    ? val
    : (config as unknown as Record<string, unknown>)[key as string];
};
...
(
  GradualBlurMemo as unknown as { CURVE_FUNCTIONS: typeof CURVE_FUNCTIONS }
